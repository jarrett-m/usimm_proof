...
#define HASH_VALUE_SIZE 4 // HASH_VALUE_SIZE hash values can be fit into one cache line 
...
#define CNT_1st_SIZE 64 // number of counter per cache line in first level of ToC
#define CNT_2nd_SIZE  (CNT_1st_SIZE/2) // number of counter per cache line in 2nd level of ToC
#define CNT_3rd_SIZE  (CNT_2nd_SIZE/2) // number of counter per cache line in 3nd level of ToC
...
//int find_counters (unsigned long long int addr, unsigned long long int capacity, 
//				   unsigned long long int data_start,unsigned long long int *counters );
				
//int find_counters_for_counters (unsigned long long int addr, microoptype_t type, unsigned long long int capacity, 
//				   unsigned long long int data_start,unsigned long long int *counters);
